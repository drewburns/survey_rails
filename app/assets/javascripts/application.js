...
$(document).ready(function(){ 
  ...
  $(".question_type_edit").toggle();
	...
	$( ".question_text_button_edit" ).click(function() {
  	...
  	$( form ).find(".question_text_edit").toggle();
  	$( form ).find(".question_type_edit").toggle();
  	$( form ).find(".question_text_solid").toggle();
  	$( form ).find(".question_type_solid").toggle();
  	$( form ).find(".question_text_button_confirm").toggle();
  	$( form ).find(".question_text_button_edit").toggle();
	});
	...
	$( ".question_form" ).submit(function( event ) {
		...
		$( this ).find(".question_text_edit").toggle();
  	$( this ).find(".question_type_edit").toggle();
  	$( this ).find(".question_text_solid").toggle();
  	$( this ).find(".question_type_solid").toggle();
  	$( this ).find(".question_text_button_confirm").toggle();
  	$( this ).find(".question_text_button_edit").toggle();
  	$( this ).find('.question_text_solid').html( text );
    $( this ).find('.question_type_solid').html( question_type );
	});
});
